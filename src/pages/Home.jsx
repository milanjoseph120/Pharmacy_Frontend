...
<div>
  <div className='container-fluid p-0'>
    <Row className='align-items-center p-5' style={{ backgroundColor: 'orange' }}>
      <Col sm={12} md={6}>
        <h1 className='display-3 text-white'>Take It Easy <span className='text-success'>PharmEasy</span></h1>
        <p>PharmEasy is one of India's most trusted online pharmacy & medical stores offering pharmaceutical and healthcare products.</p>
        <Link to={'/login'} className='btn btn-dark rounded'>Admin Only Login <i className="fas fa-arrow-right ms-3"></i></Link>
      </Col>
      <Col sm={12} md={6}>
        <img src={titleimage} alt="no image" className='w-100' style={{ marginTop: "100px" }} />
      </Col>
    </Row>
  </div>
</div>
...
<div className='offers mt-5'>
  ...
  <marquee scrollAmount={20}>
    <div className='d-flex mt-5'>
      ...
      {/* Add MedicineOffers2, MedicineOffers3, MedicineOffers4 similarly */}
      <div  className='ms-5'>
      <MedicineOffers2/>
    </div>
    <div  className='ms-5' >
  ...
  {/* Uncomment the code below if you want a "See More Medicines" link */}
  {/* <div className='text-center mt-5'>
    <Link to={'/medicine'}>See More Medicines</Link>
  </div> */}
</div>
...
<div className='medicines mt-5'>
  ...
  <div className='d-flex justify-content-center mt-5 flex-wrap'>
    <Card style={{ width: '18rem', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} className='m-3'>
      <Card.Img height={"200px"} variant="top" src={medicine} />
      <Card.Body>
        <Card.Title className='text-center fw-bold'>Medicines</Card.Title>
      </Card.Body>
