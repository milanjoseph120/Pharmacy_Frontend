...
<>
  ...
  >
    ...
    <Modal.Body>
      <Row>
        <Col md={6}>
          <img style={{ height: "100%", width: "100%" }} src={itemss ? `${BASE_URL}/uploads/${itemss.image}` : "https://himalayawellness.in/cdn/shop/products/kofflet-syrup-100ml.jpg?v=1622100457"} alt="no-image" className="img-fluid" />
        </Col>
      ...
      <div className='d-flex align-items-center justify-content-center mt-3 '>
        <Button onClick={() => dispatch(addToWishList(itemss))} variant="outline-danger btn rounded"><i className="fa-solid fa-heart"></i></Button>
        <Button onClick={() => dispatch(addtocart(itemss))} className='ms-3' variant="outline-success btn rounded"><i className="fa-solid fa-cart-plus"></i></Button>
      </div>
    </Modal.Body>
  </Modal>
  <ToastContainer autoClose={2000} theme='colored' position='top-center' />
